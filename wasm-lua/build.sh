...
emcc -O2 \
  ...
  -sNO_EXIT_RUNTIME=1 \
  -sSTACK_SIZE=1048576 \
  -sEXPORTED_FUNCTIONS='["_malloc","_free","_lua_bridge_newstate","_lua_bridge_newthread","_lua_bridge_load","_lua_bridge_resume","_lua_bridge_tostring","_lua_bridge_clearstack","_lua_bridge_close","_lua_bridge_setup_hook"]' \
